...
export default function UserCourses() {
  ...
  useEffect(() => {
    fetch(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/v1/users/courses/`, {
      headers: {
                      ...
                      <div class="main__box-right">
                        <a class="main__box-img-link" href="#">
                          <img
                            ...
                            src={`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/courses/covers/${course.course.cover}`}
                          />
                        </a>
                      </div>
